...
var ContactComponent = (function () {
    ...
    ContactComponent.prototype.sendEmail = function (form) {
        ...
        Email.send("no-reply@tonyma.com", "kevinma91@yahoo.com", "NEW MESSAGE FROM YOUR WEBSITE", "Name " + form.name + " Phone #: " + form.phone + " Email: " + form.email + " Message: " + form.message, {
...
var ListingShowComponent = (function () {
    ...
    ListingShowComponent.prototype.changeImage = function (index) {
        $('.img' + this.imageindex).removeClass("focusimage");
